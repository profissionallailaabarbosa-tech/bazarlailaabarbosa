...
export default function OrderTracking() {
  ...
  const handleSearch = async (e) => {
    ...
    try {
      // Busca pedidos pelo telefone (limpando caracteres especiais se precisar)
    ...
    <div className="min-h-screen bg-rose-50/30 py-10 px-4 font-sans">
      <div className="max-w-xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 text-sm">Digite seu número de WhatsApp para ver o status das suas compras.</p>
        </div>
